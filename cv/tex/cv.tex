...
h-index: \htmladdnormallink{20 (Google Scholar)}{http://scholar.google.com/citations?user=nwPxp24AAAAJ}, \htmladdnormallink{16 (ResearcherID)}{http://www.researcherid.com/rid/G-4238-2010}

\subsection*{Reviewed Papers}

\begin{enumerate}
\item[36.] S. M. Mniszewski, J. Belak, J.-L. Fattebert, C. F. A. Negre, S. RSlattery, A. A. Adedoyin, R. F. Bird, C.S. Chang, G. Chen, S. Ethier, S. Fogerty, S. Habib, \textbf{C. Junghans}, D. Lebrun-Grandie, J. Mohd-Yusof, S. G. Moore, D. Osei-Kuffuor, S. J. Plimpton, A. Pope, S. T. Reeve, L. Ricketson, A. Scheinberg, A. Y. Sharma, and M. E. Wall,
  \textit{Enabling Particle Applications forExascale Computing Platforms},
  To appear in Int. J. High Perf. Comp. App. (2021).

\item[35.] J. Bakosi, R. Bird, F. Gonzalez, \textbf{C. Junghans}, W. Li, H. Luo, A. Pandare, and J. Waltz,
  \textit{Asynchronous distributed-memory task-parallel algorithm for compressible flows on unstructured 3D Eulerian grids},
  To appear in Adv. Eng. Softw. (2021).
